...
_PROC_NOMES_FALLBACK = {
    # Fonte: Produção Ambulatorial — Procedimentos da Tabela Unificada (Excel clínica)
    ...
    "0405050372": "FACOEMULSIFICACAO COM IMPLANTE DE LENTE INTRA-OCULAR DOBRAVEL",
    # Complementares
    "0301010064": "CONSULTA MEDICA EM ATENCAO BASICA",
    "0405010053": "CONSULTA OFTALMOLOGICA",
    "0211070121": "RETINOGRAFIA SEM COLORACAO (DIGITAL)",
    "0211070130": "RETINOGRAFIA COLORIDA (DIGITAL)",
    "0211070149": "TOMOGRAFIA DE COERENCIA OPTICA",
}
